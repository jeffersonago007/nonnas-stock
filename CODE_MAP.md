...
Estado: pós-T20 + T-LOT-09 (MVP 1.0 em produção interna) + T-CANAL-00..04 (MVP 1.2 canais — fundação + adapter genérico + pipeline de baixa de estoque + CRUD APIs; falta UI em T-CANAL-05).
