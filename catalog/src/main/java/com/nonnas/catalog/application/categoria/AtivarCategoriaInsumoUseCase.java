...
@Service
public class AtivarCategoriaInsumoUseCase {

    private final CategoriaInsumoRepository repository;
    private final Clock clock;

    public AtivarCategoriaInsumoUseCase(CategoriaInsumoRepository repository, Clock clock) {
    ...
    public CategoriaInsumo execute(UUID id) {
        ...
        categoria.ativar(clock.instant());
