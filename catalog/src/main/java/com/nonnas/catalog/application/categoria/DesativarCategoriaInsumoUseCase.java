...
@Service
public class DesativarCategoriaInsumoUseCase {

    private final CategoriaInsumoRepository repository;
    private final Clock clock;

    public DesativarCategoriaInsumoUseCase(CategoriaInsumoRepository repository, Clock clock) {
    ...
    public CategoriaInsumo execute(UUID id) {
        ...
        categoria.desativar(clock.instant());
