...
@Service
public class DesativarUnidadeMedidaUseCase {

    private final UnidadeMedidaRepository repository;
    private final Clock clock;

    public DesativarUnidadeMedidaUseCase(UnidadeMedidaRepository repository, Clock clock) {
    ...
    public UnidadeMedida execute(UUID id) {
        ...
        unidade.desativar(clock.instant());
