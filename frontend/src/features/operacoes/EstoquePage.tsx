...
export function EstoquePage() {
  ...
  const [categoriaId, setCategoriaId] = useState(CATEGORIA_TODAS);

  const posicaoQuery = useQuery({
    queryKey: ['posicao', { filialId, categoriaId }],
    queryFn: () => listarPosicao(filialId, categoriaId === CATEGORIA_TODAS ? undefined : categoriaId),
  });
