...
@Service
public class AtivarProdutoVendavelUseCase {

    private final ProdutoVendavelRepository repository;
    private final Clock clock;

    public AtivarProdutoVendavelUseCase(ProdutoVendavelRepository repository, Clock clock) {
